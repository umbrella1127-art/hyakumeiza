...
BASE_POINTS = {
    ...
    "東京": (35.69, 139.69), "神奈川": (35.44, 139.64), "新潟": (37.90, 139.02),
    ...
    "広島": (34.39, 132.46), "山口": (34.19, 131.47), "徳島": (34.07, 134.56),
    "香川": (34.34, 134.05), "愛媛": (33.84, 132.77), "高知": (33.56, 133.53),
    "福岡": (33.59, 130.40), "佐賀": (33.25, 130.30), "長崎": (32.74, 129.87),
    "熊本": (32.79, 130.74), "大分": (33.24, 131.61), "宮崎": (31.91, 131.42),
    "鹿児島": (31.60, 130.56), "沖縄": (26.33, 127.68),
}
...
with tab_auto:
    ...
    base_name = st.selectbox("拠点を選ぶ（お住まいの都道府県）",
                             list(BASE_POINTS.keys()), index=9)  # 既定:群馬
    blat, blon = BASE_POINTS[base_name]
    st.caption("※選んだ都道府県の県庁所在地から近い順に山を表示します。")
